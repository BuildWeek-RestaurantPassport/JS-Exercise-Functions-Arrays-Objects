...
//console.log((celcius + 'degrees Celsius is ' + temperatureCtoF(celcius, fahrenheit) + ' degrees Fahrenheit'))
/**
...
//   return temperatureCtoF(celcius,fahrenheit)
//  }
// }
//console.log((temperatureInF(24, 'C') + 'F'));
